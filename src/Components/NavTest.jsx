        ...
        <div className="navWrapper">
          <div className="navWrapperContainer max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-3">
            ...
            <div className="NavRight w-1/2 sm:w-1/3 md:w-1/6 flex justify-evenly ">
              <div className="icon1 cursor-pointer self-center ">
                <i class="ri-notification-line text-xl"></i>
                <span className="notificationNumber">2</span>
              </div>
              <div className="icon2 cursor-pointer self-center">
                <i class="ri-global-line  text-xl"></i>
                <span className="globalNumber">1</span>
              </div>
              <div className="icon3 cursor-pointer self-center">
